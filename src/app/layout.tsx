  ...
  return (
    <html lang="en" data-theme="insights">
      ...
      <body className={roboto.className + " flex w-full min-h-screen flex-col items-center pt-12 md:pt-14"}>
        ...
        <Script id="gtranslate">{`window.gtranslateSettings = {"default_language":"en","languages":["en","zh-CN","zh-TW","fr","de","ja","ko"],"wrapper_selector":".gtranslate_wrapper","switcher_horizontal_position":"right"}`}</Script>
